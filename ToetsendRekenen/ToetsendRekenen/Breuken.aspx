...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="left-content">
        ...
        <asp:RegularExpressionValidator ID="REV" ControlToValidate="tbantwoordD" runat="server" ErrorMessage="Begin altijd met een getal ookal is die 0! Maximaal 3 getallen." ValidationExpression="^\d{1,3}([\.\,]\d{1,3})?$" Font-Bold="True" ForeColor="Red"></asp:RegularExpressionValidator>
        <br />
